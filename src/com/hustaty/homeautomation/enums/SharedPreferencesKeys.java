...
public enum SharedPreferencesKeys {
    ...
    APPLICATIONPREFERENCES_RECEIVED_PUBLIC_SSL_PORT(GCMMessageContent.PUBLIC_SSL_PORT.getKey()), //repeatedly updated via GCM
    ...
    APPLICATIONPREFERENCES_TTS_NOTIFICATIONS("ttsNotifications"),
